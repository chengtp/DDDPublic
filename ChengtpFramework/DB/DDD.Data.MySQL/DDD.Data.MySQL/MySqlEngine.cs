...
namespace DDD.Data.MySQL
{
    ...
    public class MySqlEngine : IDbEngine
    {
        ...
        const string PagingTableName = "DDD_TEMTABLE_PAGING";
        ...
        public async Task<IEnumerable<T>> QueryAsync<T>(ServerInfo server, ICommand cmd)
        {
            if (cmd.Query == null)
            {
                throw new DDDException("ICommand.Query is null");
            }
            ...
            switch (cmd.Query.QueryType)
            {
                ...
                default:
                    ...
                    if (AggregateOperateMustNeedField(cmd.Operate))
                    {
                        ...
                        {
                            throw new DDDException($"you must specify the field to perform for the {funcName} operation");
                        }
