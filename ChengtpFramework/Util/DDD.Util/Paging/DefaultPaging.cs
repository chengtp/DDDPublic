...
namespace DDD.Util.Paging
{
    ...
    public class DefaultPaging<T> : IPaging<T>
    {
        ...
        /// <summary>
        /// Returns an enumerator that iterates through the DDD.Util.Paging.Paging<>
        /// </summary>
        /// <returns>A DDD.Util.Paging.Paging<>.Enumerator for the DDD.Util.Paging.Paging<></returns>
